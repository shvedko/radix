		...
		for _, tt := range tests {
			t.Run(tt.name, func(t *testing.T) {
				...
				for i := range tt.want.g {
					...
					require.True(t, a.bit2(unpack(got)), i)
					got++
				}
			})
		}
